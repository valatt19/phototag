function addPolygon(){
    ...
    function handleMouseDown(e) {
        ...
        if (points.length > 2 && isNear(mouseX,mouseY,points[0].x,points[0].y,isNearZone)) {
            ...
            save_modifications(boxes,"add","polygon",document.getElementById("classes").getElementsByTagName("li")[current].innerHTML);
...
function modifyPolygon(index) {
    ...
    function myUp(){
        ...
        expectResize = -1;
        clear(ctx);
        save_modifications(boxes,"modify","polygon",document.getElementById("classes").getElementsByTagName("li")[boxes[index].type].innerHTML);
